...
export default function Home(){
  ...
  <div className="scribble"><br/></div>
    ...
    <section className="pet-home">
      ...
      <div className="pet-art photo-card"><img src={siteContent?.home?.petImage || "/hero.jpg"} alt="16FLAMES lifestyle collection" onError={(e)=>{e.currentTarget.src="/21.jpg"}} /></div>
    </section>
